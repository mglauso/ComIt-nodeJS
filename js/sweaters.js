function obtenerSweaters(url, callback) {
    let todos;
...
let contenedor = document.querySelector("#sweaters");
...
obtenerSweaters("http://localhost:5500/api/productos?categoria=Sweaters", mostrarProductos);