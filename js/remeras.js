function obtenerRemeras(url, callback) {
    let todos;
...
let contenedor = document.querySelector("#remeras");
...
obtenerRemeras("http://localhost:5500/api/productos?categoria=Remeras", mostrarProductos);