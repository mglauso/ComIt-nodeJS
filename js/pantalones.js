function obtenerPantalones(url, callback) {
    let todos;
...
let contenedor = document.querySelector("#pantalones");
...
obtenerPantalones("http://localhost:5500/api/productos?categoria=Pantalones", mostrarProductos);